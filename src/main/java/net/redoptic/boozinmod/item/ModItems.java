...
public class ModItems {
    ...
    public static final Item BEER_MUG_FULL = registerItem("beer_mug_full", new Item(new Item.Settings()));
    public static final Item MEAD_GLASS_EMPTY = registerItem("mead_glass_empty", new Item(new Item.Settings()));
    public static final Item MEAD_GLASS_FULL = registerItem("mead_glass_full", new Item(new Item.Settings()));
    public static final Item MOONSHINE_JAR_EMPTY = registerItem("moonshine_jar_empty", new Item(new Item.Settings()));
    public static final Item MOONSHINE_JAR_FULL = registerItem("moonshine_jar_full", new Item(new Item.Settings()));
    public static final Item RUM_GLASS_EMPTY = registerItem("rum_glass_empty", new Item(new Item.Settings()));
    public static final Item RUM_GLASS_FULL = registerItem("rum_glass_full", new Item(new Item.Settings()));
    public static final Item RUM_GLASS_UNAGED_FULL = registerItem("rum_glass_unaged_full", new Item(new Item.Settings()));
    public static final Item WHISKEY_GLASS_EMPTY = registerItem("whiskey_glass_empty", new Item(new Item.Settings()));
    public static final Item WHISKEY_GLASS_FULL = registerItem("whiskey_glass_full", new Item(new Item.Settings()));
    public static final Item WINE_GLASS_EMPTY = registerItem("wine_glass_empty", new Item(new Item.Settings()));
    public static final Item WINE_GLASS_FULL = registerItem("wine_glass_full", new Item(new Item.Settings()));
    public static final Item UNDISTILLED_RUM = registerItem("undistilled_rum", new Item(new Item.Settings()));
    public static final Item UNDISTILLED_WHISKEY = registerItem("undistilled_whiskey", new Item(new Item.Settings()));
